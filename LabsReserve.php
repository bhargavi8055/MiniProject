...
if($reservetime>=$submissiontime){
	...
	echo "<html>
          ...
          ";
header("refresh:2; url=LabsReserve.html");

}
else{
$sql="select * from labs_reservation where  reserved_time = '$reservetime'";
...
$q1="insert into labs_reservation(section,laboratory,reserved_time,submission_time) values('$section','$lab','$reservetime','$submissiontime')";
